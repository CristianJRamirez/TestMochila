...
/**
 * Created by 45858000w on 19/04/17.
 */
public class ProblemaMochila {
    ...
    public void cargarDatos() {
        ...
        assertEquals("Error en la carga de datos!",almacen.size(),mochila.size(),0);
    }
    ...
    public void resolverProblema() {
        ...
        while(pesoMochila<pesoMaximo && posicion < almacen.size()) {
            ...
            assertTrue ("Control sobre si el peso de la mochila mas otro elemento del almacen sobrepasa el peso maximo de la mochial", pesoMochila + tmp.peso <= pesoMaximo);
